...
class MvtstkService extends __BaseService {
  ...
  correctionStockNeg(body?: MvtStkDto): __Observable<MvtStkDto> {
    return this.correctionStockNegResponse(body).pipe(__map((_r) => _r.body as MvtStkDto));
  }
  ...
  correctionStockPos(body?: MvtStkDto): __Observable<MvtStkDto> {
    return this.correctionStockPosResponse(body).pipe(__map((_r) => _r.body as MvtStkDto));
  }
  ...
  entreeStock(body?: MvtStkDto): __Observable<MvtStkDto> {
    return this.entreeStockResponse(body).pipe(__map((_r) => _r.body as MvtStkDto));
  }
  ...
  mvtStkArticle(idArticle: number): __Observable<Array<MvtStkDto>> {
    return this.mvtStkArticleResponse(idArticle).pipe(__map((_r) => _r.body as Array<MvtStkDto>));
  }
  ...
  sortieStock(body?: MvtStkDto): __Observable<MvtStkDto> {
    return this.sortieStockResponse(body).pipe(__map((_r) => _r.body as MvtStkDto));
  }
  ...
  stockReelArticle(idArticle: number): __Observable<number> {
    return this.stockReelArticleResponse(idArticle).pipe(__map((_r) => _r.body as number));
  }
}

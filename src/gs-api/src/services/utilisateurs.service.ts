...
class UtilisateursService extends __BaseService {
  ...
  findAll(): __Observable<Array<UtilisateurDto>> {
    return this.findAllResponse().pipe(__map((_r) => _r.body as Array<UtilisateurDto>));
  }
  ...
  save(body?: UtilisateurDto): __Observable<UtilisateurDto> {
    return this.saveResponse(body).pipe(__map((_r) => _r.body as UtilisateurDto));
  }
  ...
  delete(idUtilisateur: number): __Observable<null> {
    return this.deleteResponse(idUtilisateur).pipe(__map((_r) => _r.body as null));
  }
  ...
  findByEmail(email: string): __Observable<UtilisateurDto> {
    return this.findByEmailResponse(email).pipe(__map((_r) => _r.body as UtilisateurDto));
  }
  ...
  changerMotDePasse(body?: ChangerMotDePasseUtilisateurDto): __Observable<UtilisateurDto> {
    return this.changerMotDePasseResponse(body).pipe(__map((_r) => _r.body as UtilisateurDto));
  }
  ...
  findById(idUtilisateur: number): __Observable<UtilisateurDto> {
    return this.findByIdResponse(idUtilisateur).pipe(__map((_r) => _r.body as UtilisateurDto));
  }
}

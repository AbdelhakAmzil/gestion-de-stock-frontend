...
class EntreprisesService extends __BaseService {
  ...
  findAll(): __Observable<Array<EntrepriseDto>> {
    return this.findAllResponse().pipe(__map((_r) => _r.body as Array<EntrepriseDto>));
  }
  ...
  save(body?: EntrepriseDto): __Observable<EntrepriseDto> {
    return this.saveResponse(body).pipe(__map((_r) => _r.body as EntrepriseDto));
  }
  ...
  delete(idEntreprise: number): __Observable<null> {
    return this.deleteResponse(idEntreprise).pipe(__map((_r) => _r.body as null));
  }
  ...
  findById(idEntreprise: number): __Observable<EntrepriseDto> {
    return this.findByIdResponse(idEntreprise).pipe(__map((_r) => _r.body as EntrepriseDto));
  }
}

...
class CommandesclientsService extends __BaseService {
  ...
  findAll(): __Observable<Array<CommandeClientDto>> {
    return this.findAllResponse().pipe(__map((_r) => _r.body as Array<CommandeClientDto>));
  }
  ...
  save(body?: CommandeClientDto): __Observable<CommandeClientDto> {
    return this.saveResponse(body).pipe(__map((_r) => _r.body as CommandeClientDto));
  }
  ...
  deleteArticleResponse(
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl +
        `/gestiondestock/v1/commandesclients/delete/article/${params.idCommande}/${params.idLigneCommande}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteArticle(
    ...
    return this.deleteArticleResponse(params).pipe(__map((_r) => _r.body as CommandeClientDto));
  }
  ...
  delete(idCommandeClient: number): __Observable<null> {
    return this.deleteResponse(idCommandeClient).pipe(__map((_r) => _r.body as null));
  }
  ...
  updateArticleResponse(
    ...
    let req = new HttpRequest<any>(
      'PATCH',
      this.rootUrl +
        `/gestiondestock/v1/commandesclients/update/article/${params.idCommande}/${params.idLigneCommande}/${params.idArticle}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  updateArticle(
    ...
    return this.updateArticleResponse(params).pipe(__map((_r) => _r.body as CommandeClientDto));
  }
  ...
  updateClientResponse(
    ...
    let req = new HttpRequest<any>(
      'PATCH',
      this.rootUrl +
        `/gestiondestock/v1/commandesclients/update/client/${params.idCommande}/${params.idClient}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  updateClient(
    ...
    return this.updateClientResponse(params).pipe(__map((_r) => _r.body as CommandeClientDto));
  }
  ...
  updateEtatCommandeResponse(
    ...
    let req = new HttpRequest<any>(
      'PATCH',
      this.rootUrl +
        `/gestiondestock/v1/commandesclients/update/etat/${params.idCommande}/${params.etatCommande}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  updateQuantiteCommandeResponse(
    ...
    let req = new HttpRequest<any>(
      'PATCH',
      this.rootUrl +
        `/gestiondestock/v1/commandesclients/update/quantite/${params.idCommande}/${params.idLigneCommande}/${params.quantite}`,
      __body,
      {
        headers: __headers,
        params: __params,

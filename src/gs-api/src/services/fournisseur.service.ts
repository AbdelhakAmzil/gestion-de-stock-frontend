...
class FournisseurService extends __BaseService {
  ...
  findAll(): __Observable<Array<FournisseurDto>> {
    return this.findAllResponse().pipe(__map((_r) => _r.body as Array<FournisseurDto>));
  }
  ...
  save(body?: FournisseurDto): __Observable<FournisseurDto> {
    return this.saveResponse(body).pipe(__map((_r) => _r.body as FournisseurDto));
  }
  ...
  delete(idFournisseur: number): __Observable<null> {
    return this.deleteResponse(idFournisseur).pipe(__map((_r) => _r.body as null));
  }
  ...
  findById(idFournisseur: number): __Observable<FournisseurDto> {
    return this.findByIdResponse(idFournisseur).pipe(__map((_r) => _r.body as FournisseurDto));
  }
}
